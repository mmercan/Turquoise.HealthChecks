...
import { Mail } from 'app/main-fuse/apps/mail-ngrx/mail.model';
import { MailNgrxService } from 'app/main-fuse/apps/mail-ngrx/mail.service';
import * as fromStore from 'app/main-fuse/apps/mail-ngrx/store';

import { locale as english } from 'app/main-fuse/apps/mail-ngrx/i18n/en';
import { locale as turkish } from 'app/main-fuse/apps/mail-ngrx/i18n/tr';
