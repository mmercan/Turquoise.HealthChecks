...
import { getMailsState } from 'app/main-fuse/apps/mail-ngrx/store/selectors';
import * as MailsActions from 'app/main-fuse/apps/mail-ngrx/store/actions/mails.actions';
