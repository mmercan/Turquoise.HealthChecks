...
@NgModule({
  ...
  providers: [NamespaceAppService, DeploymentAppService, K8sServiceService, K8sEventService, SignalRService, OfflineNotificationService],
})
  ...
  static forRoot(): ModuleWithProviders<any> {
    return {
      ...
      providers: [NamespaceAppService, DeploymentAppService, K8sServiceService, K8sEventService,
        SignalRService, OfflineNotificationService],
    };
  }
}
