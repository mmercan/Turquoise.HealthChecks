...
{
    public class DeploymentSchedulerScaleDownRepository<T> where T : new()
    {
        ...
        private ILogger<DeploymentSchedulerScaleDownRepository<T>> logger;
        private ObservableCollection<IScheduledTask<T>> items;

        public DeploymentSchedulerScaleDownRepository(ILogger<DeploymentSchedulerScaleDownRepository<T>> logger)
        {
            this.logger = logger;
