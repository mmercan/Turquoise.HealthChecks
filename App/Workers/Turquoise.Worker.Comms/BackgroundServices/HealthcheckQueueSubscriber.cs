...
namespace Turquoise.Worker.Comms.BackgroundServices
{
    public class NotifyServiceHealthCheckQueueSubscriber : BackgroundService
    {
        ...
        private void SubscribeQueue()
        {
            try
            {
                ...
                logger.LogCritical("Subscribing on " + configuration["queue:nofity"] + " for the type of " + typeof(NotifyServiceHealthCheck).Name);
                ;
