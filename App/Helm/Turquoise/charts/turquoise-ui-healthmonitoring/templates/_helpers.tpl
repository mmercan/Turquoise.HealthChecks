...
app: {{ include "Turquoise.UI.HealthMonitoring.name" . }}
...
{{- define "Turquoise.UI.HealthMonitoring.annotations" -}}
...
{{- define "Turquoise.UI.HealthMonitoring.service.annotations" -}}
