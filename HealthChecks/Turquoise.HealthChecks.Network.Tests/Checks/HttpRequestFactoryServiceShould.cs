...
using Turquoise.HealthChecks.Network.HttpRequest;
...
namespace Turquoise.HealthChecks.Network.Tests.Checks
{
    public class HttpRequestFactoryServiceShould
    {
        ...
        public void RunHealthCheckwithContentConverter()
        {
            ...
            Turquoise.HealthChecks.Network.HttpResponseExtensions.ContentAsType<MockData>(result.Item1);
            Turquoise.HealthChecks.Network.HttpResponseExtensions.ContentAsJson(result.Item1);
            Turquoise.HealthChecks.Network.HttpResponseExtensions.ContentAsString(result.Item1);
